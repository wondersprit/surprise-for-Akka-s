...
function showCakeGameKowsi() {
    ...
    overlay.style = `
        ...
        background:linear-gradient(135deg,#2e1a35 80%,#fff0 100%);
        opacity:0.93;z-index:1999;pointer-events:none;transition:opacity 1.2s;
    `;
    ...
    section.innerHTML = `
        <div class="cake-zone" style="text-align:center;">
            <div class="hint-msg" id="cake-hint-msg">Tap the candles to light them!</div>
                ...
                <g id="candles">
                    ${[...Array(10)].map((_,i)=>{
                        ...
                        <g class="candle" data-idx="${i}">
                            ...
                            <ellipse class="candle-flame" cx="${x}" cy="36" rx="5" ry="8" fill="#ffd966"/>
                        </g>`;
                    }).join("")}
                </g>
            </svg>
    ...
    function updateDarkness() {
        ...
        overlay.style.opacity = (0.93 - ratio*0.9).toFixed(2);
    }
    ...
    function friendlyLightAnimation() {
        for(let i=0;i<15;i++){
    ...
    function showBirthdayPopup() {
        ...
        setTimeout(()=>{ msg.style.opacity = 0; }, 1700);

...
function showCelebrationKowsi() {
    ...
    setTimeout(()=>{
        ...
        showGallery("gallery-kowsi", kowsiGallery, "diary-section-kowsi", function(){
...
function showCelebrationSneha() {
    ...
    setTimeout(()=>{
        celebrationDiv.classList.add("hidden");
        showGallery("gallery-sneha", snehaGallery, "diary-section-sneha", function(){
...
function showGallery(galleryId, images, sectionId, onFinish) {
    ...
    gallery.onclick = nextImg;
    function nextImg() {
        idx++;
        if(idx < images.length) showImg();
        else {
            gallery.innerHTML = "<em>That's all! Enjoy your message below.</em>";
...
// Sneha page: run quiz, then bonk game, then celebration, then gallery, then message
document.addEventListener("DOMContentLoaded", function() {
    if(document.getElementById("quiz-section-sneha")) {
        runQuiz("quiz-section-sneha", snehaQuiz, showBonkGame);
    }
...
// Kowsi page: run quiz, then candle game, then celebration, then gallery, then message
document.addEventListener("DOMContentLoaded", function() {
    if(document.getElementById("quiz-section-kowsi")) {
        runQuiz("quiz-section-kowsi", kowsiQuiz, showCandleGame);
    }

...
function showCandleGame() {
    ...
    section.innerHTML = `
        <div class="candle-cake-bg" id="candle-cake-bg">
            <img src="kowsi akka birthday.png" alt="Cake" style="width:100%;border-radius:18px;">
        </div>
        <div class="candle-glow"></div>
    `;
    let cakeBg = section.querySelector("#candle-cake-bg");
    let glow = section.querySelector(".candle-glow");
    let litCount = 0;
    // Candle positions for cake image (adjust as needed for your image!)
    let positions = [
        {left: "38px", top: "18px"},
        {left: "80px", top: "10px"},
        {left: "120px", top: "16px"},
    ...
    for(let i=0; i<10; i++) {
        ...
        c.innerHTML = `
            <img src="https://upload.wikimedia.org/wikipedia/commons/3/37/Candle_icon.svg" alt="Candle" style="width:32px;height:60px;"/>

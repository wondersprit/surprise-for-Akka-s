const akkas = {
  kowsi: {
    ...
    minigameImg: "kowsi akka birthday.jpg", // Candle/cake image
    diaryImgs: [
...
function showMinigame() {
  ...
  // Custom minigame for Kowsi Akka
  if (currentAkka.displayName === "Kowsi Akka") {
    // Show cake image and 10 candles to light (simulate by clicking the cake)
    gameDiv.innerHTML = `
    ...
    // Sneha Akka: Biscuit thief tap game
    gameDiv.innerHTML = `
      <h2>${currentAkka.displayName} Minigame 🎮</h2>

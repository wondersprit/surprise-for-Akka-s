...
// --- QUIZ LOGIC WITH OPTION LABELS AND ANIMATIONS ---
...
function showCandleGame() {
    ...
    section.innerHTML = `
        <div style="position:relative;">
            <img src="kowsi akka birthday.png" alt="Cake" style="width:100%;border-radius:18px;" loading="lazy">
    ...
    for(let i=0; i<candleCount; i++) {
        ...
        c.innerHTML = `
            <img src="Candle.png" alt="Candle" style="width:32px;height:60px;" loading="lazy"/>
            <img class="flame" src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f525.svg" alt="Flame"/>
        `;
        c.onclick = function() {
...
function showBonkGame() {
    ...
    section.innerHTML = `
        ...
        <div style="position:relative;height:200px;">
            <img src="biscuits thief.png" alt="Biscuit thief" class="biscuit-bonk-img" id="bonk-img" loading="lazy"/>
        </div>
    `;
